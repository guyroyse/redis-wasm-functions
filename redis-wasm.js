...
redis.registerFunction('fizzbuzz', (client, n) => {
  ...
  const bytesFromRedis = new Uint8Array(buffer)

  const fizzBuzzInWasm = new Uint8Array([
  ...
  const module = new WebAssembly.Module(fizzBuzzInWasm)
  const instance = new WebAssembly.Instance(module)

  return instance.exports.fizzbuzz(Number(n))
})
